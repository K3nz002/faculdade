...
def configurar_tela():
   ...
   root = screen.getcanvas().master  # Obtém a janela Tkinter subjacente
...
def main():
   ...
   cores = ["red", "purple", "blue", "green", "yellow", "orange"]


   # Vincula a tecla ESC à função sair
   root.bind('<Escape>', lambda event: sair())
   root.bind('<BackSpace>', lambda event: retonar())
